  ...
  const saveMessageToFirestore = async (userMessage, assistantMessage) => {
    try {
      ...
      if (!currentConversationId) {
        ...
        const docRef = await addDoc(collection(db, 'mainBibleTools_chat'), {
        ...
        const conversationRef = doc(db, 'mainBibleTools_chat', currentConversationId);
      ...
      {messages.length > 0 && (
        <div className="px-4 py-2 bg-blue-50 border-b border-gray-200 flex justify-between items-center">
          ...
          <button 
            ...
            className="text-xs text-blue-600 hover:text-blue-800 bg-white px-2 py-1 rounded border border-blue-200 transition-colors"
          >
            New Chat
          </button>
        </div>
      ...
      <div className="flex-1 p-4 overflow-y-auto bg-gray-50">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-500">Welcome! How can I assist you today?</p>
            <p className="text-gray-400 text-sm mt-2">Try: "Tell me about the Bible"</p>
          </div>
        ) : (
